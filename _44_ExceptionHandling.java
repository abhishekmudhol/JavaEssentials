...
public class _44_ExceptionHandling {
    ...
    catch(Exception e)  //Exception here is a CLASS and we are refering it with OBJECT e //try throw an object and we have to accept it as an object 
    {         
    	System.out.println("Something went wrong");
    }
    System.out.println(j);  // 0 => if exception is occurs
