...
public class _47_throwKeyword {
    ...
    //  int i=0;
    	...
    	try
    	{
    		j=18/i;
    		if(j==0)
    			throw new ArithmeticException("I don't want to do print zero"); // we have to create object and if we want we can pass message in constructor
    	}

    	catch(ArithmeticException e)
    	{
    		//j=18/i;
    		System.out.println("that is default output "+e); // above passed message prints here after e 
