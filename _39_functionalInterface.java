...
@FunctionalInterface  // TO specify it is functional interface 
interface A          //THIS unterface is called SAM (single abstract method) interface OR functional interface 
{
	void show();
//	void run();      // ERROR if @FunctionalInterface used 
}
...
public class _39_functionalInterface 
{
...
/*
    // in java 8 they make sure that java is no more varbous by giving feature called lamda expression 
    // we can only use lamda expression only with functional interface   
*/
