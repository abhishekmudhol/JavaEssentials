...
//    	    obj1.show();       //print "hi" 10 times 
//    	    obj2.show();       //AFTER PRINTING "hi" 10 TIMES , print "hi" 10 times
...
// WHAT IF WE WANT TO EXCUTE obj2.show() WHILE EXECUTING obj1.show()  => we can use threads to do that

/**********************************************************/

// WE CANNOT EXECUTE NORMAL OBJECT IN simultenauos execution WE NEED multiple threads   

//                 MAKING NORMAL object As thread => extends class with Thread class 

class A extends Thread
{
	public void run()  // IN EVERY THREAD WE NEED TO HAVE run() METHOD
	{
		for(int i=1;i<=100;i++)
		{
			System.out.println("Hi");
...
public class _53_MultipleThreads {
    public static void main(String[] args) throws NumberFormatException {   
    	
    	A obj1=new A(); // it is thread now NOT A NORMAL OBJECT
    	B obj2=new B(); // it is thread now NOT A NORMAL OBJECT
    
    	
    	obj1.start(); // it call run() method of class A
    	obj2.start(); // it call run() method of class B
    }
