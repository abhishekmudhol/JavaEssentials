...
@Deprecated     // marked class A Deprecated here
class A
{
...
{
	@Override
//	public void showTheDataWhichBelongToThisClass()    // 's' is missing Belong , if we use annotation @Override it show error
	public void showTheDataWhichBelongsToThisClass()
...
1)
What is Annotations?
-- annotation is type of comment which is used to provide meta data or suppliment to the compiler and JVM about the program.
