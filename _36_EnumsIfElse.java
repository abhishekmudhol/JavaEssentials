...
public class _36_EnumsIfElse {
    public static void main(String[] args) {

    	Status s = Status.Pending;
    	
    	switch(s)  //- Switch supports string, integer etc, and it also support enum.
    	{
    		case Running:      //  In switch case, we do not have to pass the object refernce variable again and again i.e. for eg => Status.Running becuz it knowns whatever you pass is part of Status so directly use constant itsefl
