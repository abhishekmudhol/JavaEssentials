...
//import java.io.BufferedReader;  => The import java.io.BufferedReader conflicts with a type defined in the same file
import java.io.IOException;
import java.io.InputStreamReader;
import java.util.Scanner;

public class _50_BufferedReader {
    public _50_BufferedReader(InputStreamReader in) {
    }

    public static void main(String[] args) throws IOException{   	
    	
/* read() reads only single value i.e. 55 it read only 5 so , JAVA GIVES US SPECILIZE CLASS BufferedReader TO SOLVE THIS  */

//    	System.out.println("Enter a number");  

//    	int num = System.in.read(); //read() GIVES THE ASCII VALUES// read() is method of InputStream CLASS // throws checked exception i.e. compiler force you to handel it //read() method => The value byte is returned as an int in the range 0 to 255.
// //                                1. in is OBJECT of InputStream CLASS
// //                                2. in object is created as static VARIABLE inside System CLASS    

//  	System.out.println(num);
//    	System.out.println(num-48); // TO AVOID ASCII VAULES
    	

/***********************************************************************/

    	System.out.println("Enter a number"); // println() is method of  PrintStream CLASS
//                                                1. out is OBJECT of PrintStream CLASS
//                                                2. out object is created as static VARIABLE inside System CLASS 

/***********************************************************************/

   	// InputStreamReader in =new InputStreamReader(System.in);
   	// BufferedReader bf = new BufferedReader(in);              // BufferedReader CLASS belogs TO java.io PACKAGE
    	
   	// int num = Integer.parseInt(bf.readLine()); // readLine() GIVES a String
   	// System.out.println(num);

    //  bf.close(); // GOOD PRACTICE // CLOSING RESOURSES i.e. bf is resoure i.e. if we open file is our reponsibility TO CLOSE it

/* BufferedReader CAN TAKE INPUT FROM ANYWHERE like file , sysytem Keyboard , network we have to mentioned it in    BufferedReader bf=new BufferedReader(in); */
...
/***********************************************************************/
    	...
    	int num1 = sc.nextInt();              // we have so many methods like nextInt() 
