//            USE OF A synchronized KEYWORD to WORK WITH SHARED VARIABLE 
...
public class _56_RaceCondition {
    public static void main(String[] args) throws NumberFormatException, InterruptedException {   
        ...
        t1.join(); // join() is a method that allows the main method to wait for the other threads to come back and join.
        t2.join();
        
        System.out.println(c.count); // if our both thread reach to count same time then problem occurs , if both thread NOT access count at same time OUTPUT will be 20,000

/*SOLUTION => when t1 work with increment , t2 CANNOT work with increment i.e. t2 has to wait*/
/*              USE KEYWORD CALLED AS synchronized */
    }
} 
