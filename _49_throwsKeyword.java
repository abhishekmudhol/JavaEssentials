// ducking exception using throws keyword i.e. ducking it -MEANS- letting someone else in the call stack deal with it
/*
 *
 * IMPORTANT => IN main() METHOD we have 2 way to handel exception
 *                    1. NOT RECOMMANDED => USE throws ClassNotFoundException with main() also like we did with show() but it pass this to JVM becuz JVM calling main() and JVM STOPS the execution 
 *                    2.                    USE try-catch in main() method to handel it
 */


class A
{
	public void show() throws ClassNotFoundException  // throw the exception to method Which is calling show() i.e. here main() method calling shows (see above IMPORTANT section)
	{
//    	try
//    	{
//    		Class.forName("Calc");
...
public class _49_throwsKeyword {
...
//    	}
    	...
    	{
    		e.printStackTrace();  // prints entire stack i.e. which method is calling which
    	}
